...
public class Theater {
    ...
    private final List<Discount> listOfTheaterDiscounts;

    public Theater(LocalDateProvider provider) {
        this.provider = provider;
        this.listOfTheaterDiscounts = List.of(new SpecialMovieDiscount(), new FirstOfDayDiscount(), new SecondOfDayDiscount(),
                new TimeOfDayDiscount(), new DayOfMonthDiscount());
    ...
    public void printScheduleAsJson() {
        System.out.println(toJson(schedule));
    }
    ...
    private String toJson(List<Showing> schedule) {
